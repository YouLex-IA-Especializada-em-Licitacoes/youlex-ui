                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-2.5 flex flex-col gap-1">
                      {question.options.map((option, i) => {
                        ...
                        return (
                          <button
                            ...
                            className="flex items-center gap-1.5 rounded-control border border-line-soft pl-1 pr-2 py-1 text-left transition-colors duration-100 hover:bg-hover"
                          >
                            <span
                      ...
                      <label className="flex items-center gap-1.5 rounded-control border border-line-soft pl-1 pr-2 py-1 transition-colors duration-100 focus-within:bg-hover hover:bg-hover">
                        <input
                          value={custom[qIdx] ?? ""}
                          tabIndex={active ? 0 : -1}
                          onChange={(event) => {
